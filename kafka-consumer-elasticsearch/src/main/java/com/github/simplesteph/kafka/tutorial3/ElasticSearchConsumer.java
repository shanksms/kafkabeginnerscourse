...
public class ElasticSearchConsumer {
    ...
    public static RestHighLevelClient createClient(){
        ...
        String hostname = "kafka-project-6190018220.ap-southeast-2.bonsaisearch.net"; // localhost or bonsai url
        String username = "cvbd212zfr"; // needed only for bonsai
        String password = "jjlhlztwlv"; // needed only for bonsai
